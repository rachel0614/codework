# -*- coding: utf-8 -*-
"""
Created on Mon Aug 16 17:04:48 2021
...
def letter_seg(lines_img, x_lines, i):
	...
	for e in range(len(letter)):
		if(letter[e][0]<x_linescopy[0]):
			...
			cv2.imwrite(base_dir +'/segmented_img/img1/'+str(i+1)+'_'+str(word)+'_'+str(letter_index)+'.jpg', 255-letter_img)
		else:
			x_linescopy.pop(0)
			word += 1
			letter_index = 1
...
print("\n........Program Initiated.......\n")
src_img= cv2.imread(base_dir + '522.jpg', 1)
copy = src_img.copy()
...
print("\n Resizing Image........")
src_img = cv2.resize(copy, dsize =(300, int(300*height/width)), interpolation = cv2.INTER_AREA)
