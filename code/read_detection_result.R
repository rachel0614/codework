...
checkNMS <- function(df1){
  ...
  df <- data.frame(DT)
  df1 <- df[df$vx<df$previous_2*0.5,]  #overlap 20%
  print("candidates")
  print(df1)
...
gen_detection_result("exp1019",1019) # python yolov5/detect.py --weights runs/digit/models/best95.pt  --source runs/counter632/ --save-txt  --save-crop --project runs/detection --imgsz 512 --iou-thres 0.45 --conf-thres 0.6 --save-conf --line-thickness 1
gen_detection_result("exp1021",1021) # python yolov5/detect.py --weights runs/digit/models/best92.pt  --source runs/counter632/ --save-txt  --save-crop --project runs/detection --imgsz 512 --iou-thres 0.45 --conf-thres 0.6 --save-conf --line-thickness 1
gen_detection_result("exp1022",1022) # python yolov5/detect.py --weights runs/digit/models/best98.pt  --source runs/counter140/ --save-txt  --save-crop --project runs/detection --imgsz 512 --iou-thres 0.45 --conf-thres 0.6 --save-conf --line-thickness 1
gen_detection_result("exp1030",1030) # last experiment counter 140
...
gen_detection_result("exp1052",1052) # last experiment counter20
